...
os.system("cp /data/data/com.termux/files/home/covider.py /data/data/com.termux/files/usr/bin/")
os.system("mv covider.py covider")
os.system("chmod +x covider")
print(bcolors.OKGREEN+"You can run this tool from anywhere by typing"+bcolors.PINK+" covider"+bcolors.ENDC)
time.sleep(1.5)
	        	...
	        	if check==35:
	        		...
	        		while True:
	        			...
	        			if x=="1":
	        				...
	        				print("\n")
	        				print(bcolors.BOLD+"Thank you for using us !"+bcolors.ENDC)
...
print("\n")
print(bcolors.BOLD+"1) Enter 1 to see the details of country : ")
print("2) Enter 2 to see the details of state(india)"+bcolors.ENDC)
