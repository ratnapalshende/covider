...
if not os.path.isfile("/data/data/com.termux/files/usr/bin/covider"):
	...
	os.system("mv /data/data/com.termux/files/usr/bin/covider.py /data/data/com.termux/files/usr/bin/covider")
	os.system("chmod +x /data/data/com.termux/files/usr/bin/covider")
